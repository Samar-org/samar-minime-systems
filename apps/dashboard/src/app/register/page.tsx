        ...
        <div className="bg-neutral-800 rounded-lg shadow-xl overflow-hidden border border-neutral-700">
          <div className="px-6 py-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                <label htmlFor="orgName" className="block text-sm font-medium text-neutral-300 mb-2">
            ...
            <div className="relative my-6">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-2 bg-neutral-800 text-neutral-500">Already have an account?</span>
              </div>
            </div>
